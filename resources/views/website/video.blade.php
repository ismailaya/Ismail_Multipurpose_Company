			...
			<div class="row">
				<div class="span12">
					...
					<div class="thumbnails row" id="isotope-items">
						@foreach($data as $v)
							<div class="col-md-4 isotope-element isotope-filterall pb-7 {{ $v->related }}">
								<div class="thumb-isotope">
									<div class="thumbnail clearfix">
										<video id="player-1" controls playsinline crossorigin style="width: 100%; height: 100%;" ratio="16x9"
											poster="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg"
											data-setup='' loop class="video-js">
											<source src="{{asset('storage/' . $v->file) }}" type='video/mp4'>
										</video>
									</div>
								</div>
							</div>
...
player.poster = '/assets/uploads/video/33541e287b5.jpg';
