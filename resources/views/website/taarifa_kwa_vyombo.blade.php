...
<div class="subpage">
    <div id="slider_wrapper">
        ...
        <div class="slider_bot">
            <div class="page_title text-center">Taarifa Kwa Vyombo Vya Habari</div>
            <div class="container text-white pb-10">
                <a href="./" class="link text-info">Nyumbani</a> / Taarifa Kwa Vyombo Vya Habari
            </div>
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 meyor-message">
                        <h5 class="">TAARIFA KWA VYOMBO VYA HABARI</h5>
                        <hr class="mb-3">
