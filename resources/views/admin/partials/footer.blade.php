...
<footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted">Copyright © Zanzibar City Council <?= date("Y") ?></span><br>
        <span class="d-block mt-1 mt-sm-0"><a
                href="https://developer.zanserve.com" target="_blank" class="text-white">Developed by Ismail Omar</span>
    </div>
</footer>
<!-- partial -->
</div>
